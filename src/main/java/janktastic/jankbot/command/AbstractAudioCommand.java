...
public abstract class AbstractAudioCommand extends AbstractCommand {
  
  protected static final String INVALID_VOICE_CHANNEL = "You must be in a voice channel or specify one to initiate playback.";
